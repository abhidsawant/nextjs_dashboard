...
export const toggleFavorite    = (id)  => api.post(`/favorites/${id}/toggle`);
export const getFavoriteProducts = ()  => api.get("/favorites").then(({ data }) => ({ data: { items: data.favorites, total: data.count, pages: 1 } }));